...
public class VLayout2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RecyclerView recyclerView = (RecyclerView) findViewById(R.id.other_vlayout_2);
                ...
                public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                    if (viewType == 1)
                        return new MainViewHolder(
                                LayoutInflater.from(VLayout2Activity.this).inflate(R.layout.view_pager, parent, false));
...
//        }
        ...
        adapters.add(
                new FooterAdapter(recyclerView, VLayout2Activity.this, new GridLayoutHelper(1), 1));
