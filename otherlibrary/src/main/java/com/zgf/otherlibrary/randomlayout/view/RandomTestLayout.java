 ...
 * 2、防止覆盖
 */
public class RandomTestLayout<T> extends RelativeLayout {
    /**
     * 此列表用于保存随机的View视图
    ...
    public RandomTestLayout(Context context) {
        super(context);
    }

    public RandomTestLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
